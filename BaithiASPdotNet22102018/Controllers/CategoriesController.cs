...
namespace BaithiASPdotNet22102018.Controllers
{
    public class CategoriesController : Controller
    {
        private readonly BaithiASPdotNet22102018Context _context;

        public CategoriesController(BaithiASPdotNet22102018Context context)
        {
            _context = context;
        }
